...
public class Register extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "vyom.com.tracker.MESSAGE";
    Button btnprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i_phonenumber = (EditText) findViewById(R.id.edi_phn_no);
        i_Fullname = (EditText) findViewById(R.id.edi_full_name);
        i_EmailAddress = (EditText) findViewById(R.id.edi_email_address);
        i_SOS1 = (EditText) findViewById(R.id.edi_sos_1);
        i_SOS2 = (EditText) findViewById(R.id.edi_sos_2);
        progressbar = (ProgressBar) findViewById(R.id.progress_bar);

        btnprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String phonenumber = i_phonenumber.getText().toString().trim();
                ...
                String sos2 = i_SOS2.getText().toString().trim();
                ...
                if (TextUtils.isEmpty(sos2)) {
                    Toast.makeText(getApplicationContext(), "Enter SOS number 2 !", Toast.LENGTH_SHORT).show();
                }

                progressbar.setVisibility(View.VISIBLE);

                auth.createUserWithEmailAndPassword(emailadress, phonenumber).addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            i.putExtra(EXTRA_MESSAGE,phonenumber);
